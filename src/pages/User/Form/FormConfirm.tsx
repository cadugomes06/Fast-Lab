  ...
  useEffect(() => {
    ...
    return (
        ...
        <section className="grid grid-cols-6 w-full h-[calc(100vh-80px)]">
          ...
          <main className="col-span-4  bg-gray-100/30 shadow-md shadow-gray-300 animeLeft rounded-md mt-2">
            ...
            <div className="flex justify-start w-full max-h-max px-8 mt-8">
            ...
            <div className="flex flex-col justify-start w-full max-h-max px-8 mt-8">
